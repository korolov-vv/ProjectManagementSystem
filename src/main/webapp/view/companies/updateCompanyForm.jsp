        ...
        <div class="form">
            <form action="/companies" accept-charset="utf-8" method="post"></br>
                ...
                <div class="input-container ic1">
                    <input required id="company name" class="input" type="text" name="company name"
                ...
                <div class="input-container ic2">
                    <input required id="number of developers" class="input" type="number" name="number of developers"
                           value="<c:out value='${company.numberOfDevelopers}' />"/>
                    <div class="cut"></div>
                    <label for="number of developers" class="placeholder">Number of developers</label>
                </div>
                <div class="input-container ic2">
                    <input required id="projects" class="input" type="text" name="projects" value='${projects}'/>
                    <div class="cut"></div>
                    <label for="projects" class="placeholder">Enter project Ids, separate by comma</label>
                </div>
                <div class="input-container ic2">
                    <input required id="customers" class="input" type="text" name="customers" value='${customers}'/>
                    <div class="cut"></div>
