        ...
        <div class="form">
            <form action="/developers" accept-charset="utf-8" method="post"></br>
                ...
                <div class="input-container ic2">
                    <input required id="first name" class="input" type="text" name="first name" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="first name" class="placeholder">First name</label>
                </div>
                <div class="input-container ic2">
                    <input required id="last name" class="input" type="text" name="last name" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="last name" class="placeholder">Last name</label>
                </div>
                <div class="input-container ic2">
                    <input required id="gender" class="input" type="text" name="gender" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="gender" class="placeholder">Gender</label>
                </div>
                <div class="input-container ic2">
                    <input required id="age" class="input" type="number" name="age" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="age" class="placeholder">Age</label>
                </div>
                <div class="input-container ic2">
                    <input required id="experience" class="input" type="number" name="experience" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="experience" class="placeholder">Experience</label>
                </div>
                <div class="input-container ic2">
                    <input required id="salary" class="input" type="number" name="salary" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="salary" class="placeholder">Salary</label>
                </div>
                <div class="input-container ic2">
                    <input required id="projects" class="input" type="text" name="projects" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="projects" class="placeholder">Enter project Ids, separate by comma</label>
                </div>
                <div class="input-container ic2">
                    <input required id="company" class="input" type="text" name="company" placeholder=" "/>
                    <div class="cut"></div>
                    <label for="company" class="placeholder">Enter company Id</label>
                </div>
                <div class="input-container ic2">
                    <select required id="stack" class="input" name="stack">
                ...
                <div class="input-container ic2">
                    <select required id="level" class="input" name="level">
