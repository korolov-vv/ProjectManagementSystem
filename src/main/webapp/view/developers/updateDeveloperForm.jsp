        ...
        <div class="form">
            <form action="/developers" accept-charset="utf-8" method="post"></br>
                ...
                <div class="input-container ic1">
                    <input required id="email" class="input" type="text" name="email"
                           value="<c:out value='${developer.developerEmail}' />"/>
                    <div class="cut"></div>
                    <label for="email" class="placeholder">Developer's email</label>
                </div>
                <div required class="input-container ic2">
                    <input id="first name" class="input" type="text" name="first name"
                           value="<c:out value='${developer.firstName}' />"/>
                    <div class="cut"></div>
                    <label for="first name" class="placeholder">First name</label>
                </div>
                <div required class="input-container ic2">
                    <input id="last name" class="input" type="text" name="last name"
                           value="<c:out value='${developer.lastName}' />"/>
                    <div class="cut"></div>
                    <label for="last name" class="placeholder">Last name</label>
                </div>
                <div required class="input-container ic2">
                    <input id="gender" class="input" type="text" name="gender"
                           value="<c:out value='${developer.gender}' />"/>
                    <div class="cut"></div>
                ...
                <div required class="input-container ic2">
                    <input id="experience" class="input" type="number" name="experience"
                           value="<c:out value='${developer.experienceInYears}' />"/>
                    <div class="cut"></div>
                ...
                <div class="input-container ic2">
                    <input required id="company" class="input" type="text" name="company"
                ...
                <div class="input-container ic2">
                    <select required id="stack" class="input" name="stack">
                        <option value="${skillsDTO.stack}" selected>${skillsDTO.stack}</option>
                ...
                <div class="input-container ic2">
                    <select required id="level" class="input" name="level">
                        <option value="${skillsDTO.level}" selected>${skillsDTO.level}</option>
